    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(choices=[('ACTOR', 'Actor'), ('MOVIE', 'Movie')], default='ACTOR', max_length=50)),
                ('date_assign', models.DateTimeField(auto_now_add=True)),
                ('actor_kind', models.ManyToManyField(blank=True, to='imdb.Actor')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actors', models.ManyToManyField(blank=True, to='imdb.Actor')),
            ],
        ),
        migrations.AddField(
            model_name='award',
